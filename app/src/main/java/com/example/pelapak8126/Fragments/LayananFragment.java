 ...
 * {@link LayananFragment.OnFragmentInteractionListener} interface
...
public class LayananFragment extends Fragment {
    ...
    List<LaundryService> laundryServiceList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fragmentView  = inflater.inflate(R.layout.fragment_layanan,
                container, false);
        recyclerView = fragmentView.findViewById(R.id.rv_service_layanan);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        recyclerView.setHasFixedSize(true);

        firebaseDatabase = FirebaseDatabase.getInstance();
        databaseReference = firebaseDatabase.getReference("LaundryService");
    ...
    public void onStart() {
        ...
        databaseReference.orderByChild("userId").equalTo(user.getUid()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                serviceAdapter = new ServiceAdapter(getActivity(), laundryServiceList);
